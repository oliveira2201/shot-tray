...
async function run() {
    try {
        ...
        console.log(`Sending REAL BUTTONS test (Invalid URL) to: ${targetNumber} ...`);
        ...
        const payload = {
            ...
            body: [
                {
                    phone: targetNumber, 
                    title: "Teste Botão - URL Invalida",
                    body: "Testando se URL invalida quebra o envio",
                    footer: "Rodapé Teste",
                    buttons: [
                        {
                            type: "url",
                            text: "Google",
                            url: "{{extra1}}" // Invalid URL
                        }
                    ]
                }
            ]
